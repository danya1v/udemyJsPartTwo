...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/services */ "./src/js/services/services.js");
...
function openModal(modalSelector, modalTimerId) {
  ...
  clearInterval(modalTimerId); // wasOpened = true;
}
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var modalTrigger = document.querySelectorAll(triggerSelector),
      modal = document.querySelector(modalSelector); // let wasOpened = false;
